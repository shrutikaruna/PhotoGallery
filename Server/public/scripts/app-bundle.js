...
define('modules/home',['exports', '../resources/data/users', 'aurelia-framework', 'aurelia-router', 'aurelia-auth'], function (exports, _users, _aureliaFramework, _aureliaRouter, _aureliaAuth) {
    'use strict';
...
define('modules/list',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
  ...
  var Wall = exports.Wall = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, AuthService, MyPics), _dec(_class = function () {
...
define('resources/data/mypics',[], function () {
  "use strict";
});
...
define('text!modules/home.html', ['module'], function(module) { module.exports = "<template>    <h1>$Hello World</h1>    <compose show.bind=\"showLogin\" view=\"./components/login.html\"></compose>    <compose show.bind=\"!showLogin\" view=\"./components/register.html\"></compose></template>"; });
